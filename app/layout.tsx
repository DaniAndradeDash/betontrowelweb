...
export default function Footer() {
  ...
  return (
    // Cambiamos a un ID único para asegurar que el compilador lo trate como un nodo nuevo
    <div id="main-footer-container" className="bg-[#1A1A1A] text-white pt-20 pb-10 border-t border-gray-800">
          ...
          <div className="md:col-span-4">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="group p-3 rounded-full bg-white/5 text-gray-400 hover:bg-[#1877F2] hover:text-white transition-all duration-300"
              >
                <FaFacebookF size={18} />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group p-3 rounded-full bg-white/5 text-gray-400 hover:bg-gradient-to-tr hover:from-[#f9ce34] hover:to-[#6228d7] transition-all duration-300"
              >
                <FaInstagram size={18} />
              </a>
            </div>
