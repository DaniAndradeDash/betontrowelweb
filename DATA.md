...
| **1.2** | **Reemplazar "concreto" por "concreto"** — Término correcto en México                                                                                                               | BRANDREVIEW §3.4                             | —   | `app/components/sectionsHome/HeroAction.tsx`                                                   |
...
_Este checklist es el punto de partida. Cada fase se ejecuta en orden descendente. Los items dentro de cada fase pueden ejecutarse en paralelo si no tienen dependencias entre sí._
